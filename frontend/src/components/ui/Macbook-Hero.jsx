  ...
  return (
    ...
    >
      <motion.h2
        ...
        className="text-9xl mb-20 font-bold bg-gradient-to-r from-green-600 to-lime-400 inline-block text-transparent bg-clip-text"
      >
        {title || (
          <span>
    ...
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <img
          ...
          alt="aceternity logo"
          fill
          className="object-cover shadow-lg object-center absolute rounded-lg inset-0 h-full w-full"
        />
      </motion.div>
    </div>
  );
