...
function chaincode_ready() {
	peer chaincode query -n vegetable-transfer -C mychannel -c '{"Args":["org.hyperledger.fabric:GetMetadata"]}'
}
...
check chaincode_ready "vegetable-transfer chaincode is running"
